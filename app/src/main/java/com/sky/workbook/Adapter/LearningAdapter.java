...
public class LearningAdapter extends RecyclerView.Adapter<LearningAdapter.ViewHolder> {
	...
	int[] images = {R.drawable.pngegg_c,R.drawable.pngegg_d,R.drawable.pngegg,R.drawable.pngegg,R.drawable.pngegg_a,R.drawable.pngegg_b,R.drawable.pngegg_c,R.drawable.pngegg_d,R.drawable.pngegg_a,R.drawable.pngegg_b,};
	...
	public LearningAdapter(ArrayList<String> dataset) {
		mDataset.clear();
